...
과제 3 / 作业 3
과제 3.	作业 3.
hidden layer 노드 수를 256 → 128 로 변경한 뒤 summary() 화면을 캡쳐하여 업로드.	将隐藏层节点数从 256 → 128 后，截图 model.summary() 并上传。
...
과제 4 / 作业 4
과제 4.	作业 4.
adam 대신 sgd 로 compile 한 모습을 캡쳐하여 업로드.	使用 SGD 替代 Adam 进行编译，截图并上传至 GitHub。
...
과제 5 / 作业 5
과제 5.	作业 5.
epochs=2 와 5 의 accuracy 를 비교하고 차이를 설명할 것.	比较 epochs=2 与 5 的 accuracy，并解释差异原因。
